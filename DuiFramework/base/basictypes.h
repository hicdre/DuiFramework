...
const uint64 kuint64max = ((uint64) 0xFFFFFFFFFFFFFFFFI64);
...
const  int64 kint64min =  ((int64)  0x8000000000000000I64);
const  int64 kint64max =  ((int64)  0x7FFFFFFFFFFFFFFFI64);
